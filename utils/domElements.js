...
export const startTabButtons = safeQueryAll('.start-tab');
export const singlePlayerTab = safeGetById('singlePlayerTab');
export const multiplayerTab = safeGetById('multiplayerTab');
export const startEngineBtn = safeGetById("startEngineBtn");
export const nicknameInput = safeGetById("nicknameInput");
export const roomSelect = safeGetById("roomSelect");
export const startMultiplayerBtn = safeGetById("startMultiplayerBtn");
export const playerList = safeGetById("playerList");
...
export const chatBtn = safeGetById("chatBtn");
export const chatInput = safeGetById("chatInput");
export const chatContainer = safeGetById("chatContainer");
