...
export const djEqHi = safeGetById("djEqHi");
export const djEqMid = safeGetById("djEqMid");
export const djEqLow = safeGetById("djEqLow");
export const djEqHiValue = safeGetById("djEqHiValue");
export const djEqMidValue = safeGetById("djEqMidValue");
export const djEqLowValue = safeGetById("djEqLowValue");
export const djEqBypassToggle = safeGetById("djEqBypassToggle");
...
// Performance: Scale/Key Sequencer controls
export const scaleKeySeqEnabled = safeGetById("scaleKeySeqEnabled");
export const scaleKeySeqDefaultBarsInput = safeGetById("scaleKeySeqBarsPerBlock");
export const scaleKeySeqBlocks = safeGetById("scaleKeySeqBlocks");
export const scaleKeySeqAddBlockBtn = safeGetById("scaleKeySeqAddBlockBtn");
export const scaleKeySeqClearBtn = safeGetById("scaleKeySeqClearBtn");
export const scaleKeySeqTimeLeft = safeGetById("scaleKeySeqTimeLeft");
export const scaleKeySeqProgSelect = safeGetById("scaleKeySeqProgSelect");
export const scaleKeySeqProgRootSelect = safeGetById("scaleKeySeqProgRootSelect");
export const scaleKeySeqProgScaleSelect = safeGetById("scaleKeySeqProgScaleSelect");
export const scaleKeySeqAddProgBtn = safeGetById("scaleKeySeqAddProgBtn");
